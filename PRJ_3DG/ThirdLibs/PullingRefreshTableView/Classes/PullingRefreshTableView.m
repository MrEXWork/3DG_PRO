...
//        _dateLabel.text = NSLocalizedString(@"最后更新", @"");
        ...
        _arrow.contents = (id)[UIImage imageWithCGImage:[UIImage imageNamed:@"refresh_arrow_up.png"].CGImage scale:1 orientation:UIImageOrientationDown].CGImage;
...
//    x = 0;
    ...
    if (self.isAtTop) {
        ...
        UIImage *arrow = [UIImage imageNamed:@"refresh_arrow_up"];
        ...
        UIImage *arrow = [UIImage imageNamed:@"refresh_arrow_down"];
        _arrow.contents = (id)arrow.CGImage;
...
//    __block CGRect rect = CGRectMake(0, self.contentOffset.y - 32, self.bounds.size.width, 32);
    ...
    __block CGRect rect = CGRectMake(0, self.parentView.bounds.origin.y - 32, self.parentView.bounds.size.width, 32);
    ...
    if (_msgLabel == nil) {
        ...
        [self.parentView addSubview:_msgLabel];
    }
    _msgLabel.text = msg;
